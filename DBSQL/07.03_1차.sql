...
CREATE TABLE saled_tbl (
	...
	CONSTRAINT saled_fk FOREIGN KEY (location_id) REFERENCES location_tbl (id)
	CONSTRAINT saled_fk FOREIGN KEY (contact_id) REFERENCES contact_tbl (id)
);
...
CREATE TABLE location_tbl (
	...
	CONSTRAINT location_fk FOREIGN KEY (location) REFERENCES location_tbl (id)
);
...
CREATE TABLE lecture_tbl (
	...
	CONSTRAINT lecture_fk FOREIGN KEY (subject) REFERENCES learn_tbl (lecture_id)
);
